...
region = "nino3" #choices are nino3 and nino34
...
if(ensemble == "control"){
    read_file_struct = paste("_control_",region,"_stats.txt",sep="")
    start_year = 15.
    end_year = 85.
    minor_x = 1}
if (ensemble == "forced"){
    read_file_struct = paste("_",region,"_stats.txt",sep="")
    start_year = 1865.
    end_year = 2085.
    minor_x= 5}
    #start_year = 1940.
...
if(j==1){
    pdf(paste(ensemble,"_",stat_choice,"_",plot_type,"_",region,".pdf",sep=""))
...
if(ensemble == "forced"){
  ersst_file = paste("../model_running_stats/ersst_",region,"_stats.txt",sep="")
...
save(stat_matrix,ersst_array,med_quant,low_quant,upper_quant,
    ...
    file=paste(ensemble,"_",stat_choice,".RData",sep=""))
}
if (ensemble == "control"){
