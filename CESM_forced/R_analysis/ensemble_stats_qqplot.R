...
pdf(paste(stat_choice,"_",region,"_",time_interval,"yr_qq.pdf",sep=""))
par(mar=c(5,6,4,2)+0.1)
qqnorm(stat_list[[1]],main=main_string,plot.it=TRUE)
...
###Save stat lists for qq multiplots
save(stat_list,file=paste(stat_choice,"_qqplot.RData",sep=""))
dev.off()
